...
spark = SparkSession\
        ...
        .enableHiveSupport()\
        .getOrCreate()
path="s3n://aws-a0049-use1-00-d-s3b-bpod-bdp-data01/onboarding/training/"+str(sys.argv[1])+"/results_from_airflows"
...
task1.coalesce(1).write.mode("overwrite").format("csv").save(path)
spark.stop()
